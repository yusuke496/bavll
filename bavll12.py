...
#plt.plot(x1, result1.best_fit, linewidth=1, color="black",label="fit1")
#plt.plot(x2, result2.best_fit, linewidth=1, color="red",label="fit2")
#plt.plot(x3, result3.best_fit, linewidth=1, color="blue",label="fit3")
#plt.plot(x4, result4.best_fit, linewidth=1, color="green",label="fit4")
#plt.plot(x5, result5.best_fit, linewidth=1, color="magenta",label="fit5")
